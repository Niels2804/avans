...
public class SimpleMqttClient : IDisposable
{
    ...
    public static SimpleMqttClient CreateSimpleMqttClientForHiveMQ(string clientId)
    {
        ...
        {
            Host = "0203145c1022495a968ef066d5fd6443.s1.eu.hivemq.cloud", // maak eventueel een account aan bij hivemq als dit problemen geeft.
            Port = 8883,
            ...
            UserName = "hivemq.webclient.1732785719860",
            Password = "QXv?,aHyKR<25up;0P1b"
        });
